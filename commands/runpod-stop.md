...
1. **List pods**: Run `python /Users/oscargilg/Dev/zombuul/scripts/runpod_ctl.py list`.

2. If there are multiple pods, **ask the user** which one to terminate using AskUserQuestion.

3. **Terminate**: Run `python /Users/oscargilg/Dev/zombuul/scripts/runpod_ctl.py stop <pod_id>`.
